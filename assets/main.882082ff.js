import{l as e}from"./logo.be988c5c.js";document.querySelector("#app_btn").innerHTML=`
    <nav class='navbar container p-2'>
      <div class='col-sm-2 logo'>
        <div class='header-right'>
          <img alt='logo' class='img-width' src="${e}" />
    ...
    <section class='container container-sm container-md container-lg my-5 h-100'>
...
`;console.log("43134e46f51d8005812beb8bfd746a28");
